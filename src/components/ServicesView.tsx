...
export function ServicesView({
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 w-full max-w-full overflow-x-hidden">
      {/* Sub-navigation bar */}
      <div className="bg-white border-b border-slate-200 px-3 sm:px-6 lg:px-8 py-2.5 sticky top-0 z-20 shadow-xs">
        <div className="flex items-center justify-between flex-wrap gap-2.5">
          <div className="flex items-center gap-2">
            <div className="p-1.5 bg-slate-900 text-white rounded-lg shrink-0">
              <Layers className="w-4 h-4" />
            </div>
            <span className="text-xs font-bold text-slate-700 uppercase tracking-wider">Services Catalog</span>
          ...
          <div className="flex items-center gap-1.5 overflow-x-auto py-1 w-full sm:w-auto no-scrollbar touch-pan-x">
            {tabs.map((tab) => {
              const Icon = tab.icon;
